...
class LastWorld :
 ...
 public:
  ...
  // int32 worl_id = 1;
  void clear_worl_id();
  ::PROTOBUF_NAMESPACE_ID::int32 worl_id() const;
  void set_worl_id(::PROTOBUF_NAMESPACE_ID::int32 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 worl_id_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_db_2eproto;
};
// -------------------------------------------------------------------
...
// int32 worl_id = 1;
inline void LastWorld::clear_worl_id() {
  worl_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 LastWorld::worl_id() const {
  // @@protoc_insertion_point(field_get:Proto.LastWorld.worl_id)
  return worl_id_;
}
inline void LastWorld::set_worl_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  worl_id_ = value;
  // @@protoc_insertion_point(field_set:Proto.LastWorld.worl_id)
}
