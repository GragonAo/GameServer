...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_db_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::Proto::LastWorld, worl_id_),
...
const char descriptor_table_protodef_db_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\005\"P\n\tLastWorld\022\017\n\007worl_id\030\001 \001(\005\022\020\n\010world"
  "_sn\030\002 \001(\003\022 \n\010position\030\003 \001(\0132\016.Proto.Vect"
  ...
  "ase\030\003 \001(\0132\021.Proto.PlayerBase\022\037\n\004misc\030\004 \001"
  "(\0132\021.Proto.PlayerMisc*(\n\006Gender\022\010\n\004none\020"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_db_2eproto = {
  &descriptor_table_db_2eproto_initialized, descriptor_table_protodef_db_2eproto, "db.proto", 471,
...
LastWorld::LastWorld(const LastWorld& from)
  ...
  ::memcpy(&world_sn_, &from.world_sn_,
    static_cast<size_t>(reinterpret_cast<char*>(&worl_id_) -
    reinterpret_cast<char*>(&world_sn_)) + sizeof(worl_id_));
...
void LastWorld::SharedCtor() {
  ...
  ::memset(&position_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&worl_id_) -
      reinterpret_cast<char*>(&position_)) + sizeof(worl_id_));
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          worl_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int64 world_sn = 2;
...
void LastWorld::SerializeWithCachedSizes(
  ...
  // int32 worl_id = 1;
  if (this->worl_id() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32(1, this->worl_id(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* LastWorld::InternalSerializeWithCachedSizesToArray(
  ...
  // int32 worl_id = 1;
  if (this->worl_id() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(1, this->worl_id(), target);
  }
